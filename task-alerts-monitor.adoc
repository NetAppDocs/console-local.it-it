...
Tutti i ruoli, ad eccezione di Federation admin e Federation viewer. Gli utenti con il ruolo di Federation admin o Federation viewer non possono visualizzare gli avvisi. link:reference-iam-predefined-roles.html["Scopri i ruoli di accesso"].
