...
summary: 'Usi un file OVA per installare una distribuzione locale della NetApp Console nel tuo VCenter. Il download dell"OVA o l"URL sono disponibili tramite il sito di supporto NetApp.' 
---
