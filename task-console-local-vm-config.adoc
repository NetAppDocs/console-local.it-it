...
summary: Dopo che hai distribuito la Console local deployment, puoi apportare modifiche al tuo host VCenter o ESXi esistente. 
---
...
[role="lead"]
Nella NetApp Console distribuzione locale, puoi apportare modifiche al tuo VCenter o host ESXi esistente dopo aver distribuito la Console distribuzione locale.
