...
.Passaggi
. Seleziona *Administration > Console*.
. Seleziona *Configuration* per aprire la pagina di configurazione dei sistemi.
. Nella sezione *Server di posta elettronica*, seleziona *Configura*.
. Seleziona *Cancella campi* per cancellare la configurazione esistente.
. Seleziona *Salva* per salvare la configurazione cancellata, che rimuove la configurazione del server di posta elettronica dalla distribuzione locale della Console.
