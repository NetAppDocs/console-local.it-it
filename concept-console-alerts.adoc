...
La distribuzione locale della console consolida gli avvisi provenienti dai cluster ONTAP e dalle operazioni di Backup and Recovery in un'unica visualizzazione. La pagina Avvisi include una dashboard, un elenco di avvisi e una visualizzazione che mostra gli avvisi relativi a tutti i sistemi dell'organizzazione. Ogni avviso identifica il sistema interessato, il livello di gravità e l'area di impatto.
...
* *Gravità* indica l'urgenza, dalla più alta alla più bassa: Critica, Avviso e Informativa.
* *Area di impatto* identifica il dominio interessato: Disponibilità, Capacità, Configurazione, Performance, Protezione e Sicurezza.
...
* *Gli avvisi ONTAP* provengono dall'Event Management System (EMS) di ONTAP sui cluster on-premises scoperti dalla distribuzione locale della Console, così come dalle metriche di monitoraggio raccolte da ONTAP. link:https://docs.netapp.com/us-en/ontap-ems/acp-auto-events.html["Scopri di più su ONTAP EMS e sugli avvisi disponibili."^]
...
* Si applica a tutti i sistemi dell'organizzazione.
...
* link:task-alert-rules-manage.html["Crea e gestisci le regole di notifica"]
