...
summary: Prima di poter aprire una richiesta di supporto con il supporto tecnico NetApp, devi aggiungere un account del Support Site NetApp alla distribuzione locale di NetApp Console e poi registrarti per il supporto. 
---
...
+
image:https://raw.githubusercontent.com/NetAppDocs/console-family/main/media/screenshot-serial-number.png["Uno screenshot del menu Help in cui Support è la prima opzione elencata"]
...
. Nel campo *Linea di prodotto*, seleziona *Cloud Manager* e poi seleziona il tuo cloud provider di fatturazione applicabile.
. Copia il numero di serie del tuo account dal passaggio 2 qui sopra, completa il controllo di sicurezza e poi conferma di aver letto l'Informativa globale sulla privacy dei dati di NetApp.
+
...
. Nell'angolo in alto a destra della Console, seleziona l'icona Guida e seleziona *Supporto*.
+
image:https://raw.githubusercontent.com/NetAppDocs/console-family/main/media/screenshot-help-support.png["Uno screenshot del menu Help in cui Support è la prima opzione elencata"]
...
+
Si tratta di un ID generato dal sistema che corrisponde al tuo indirizzo email. Nella pagina *Gestione NSS*, puoi visualizzare il tuo indirizzo email dal image:https://raw.githubusercontent.com/NetAppDocs/console-family/main/media/icon-nss-menu.png["Un'icona composta da tre punti orizzontali"] menu.

** Se dovessi mai aver bisogno di aggiornare i token delle tue credenziali di accesso, c'è anche un'opzione *Aggiorna credenziali* nel menu image:https://raw.githubusercontent.com/NetAppDocs/console-family/main/media/icon-nss-menu.png["Un'icona composta da tre punti orizzontali"].
+
