...
Ruota le credenziali dell'account di servizio quando cambiano i requisiti di sicurezza, invalidando i segreti precedenti e preservando l'accesso controllato alle API.
