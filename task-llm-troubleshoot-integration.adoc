...
[role="lead"]
Diagnostica i problemi di integrazione LLM nella distribuzione locale di NetApp Console per ripristinare l'accesso all'assistente della Console e risposte affidabili per la guida e le operazioni di storage.
...
| Il pulsante *Assistente console* non è presente | Stato di integrazione non integro | Salvataggio riuscito degli strumenti di AI, stato di integrazione e ruolo di accesso previsto | Aggiorna la sessione e verifica con un account admin noto e funzionante 
