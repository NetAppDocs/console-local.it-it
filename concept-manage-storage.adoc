...
link:concept-folders-fleets-overview.html["Scopri di più su cartelle e flotte nella distribuzione locale di NetApp Console"].
...
* link:concept-storage-classes.html["Scopri le classi e le policy di archiviazione nella distribuzione locale di NetApp Console"].
* link:task-iam-manage-folders-fleets.html["Impara come creare e gestire flotte"].
