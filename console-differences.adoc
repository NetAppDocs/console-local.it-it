...
NetApp offre due modalità di esecuzione per la sua piattaforma unificata di gestione dello storage: NetApp Console e NetApp Console con implementazione locale. Entrambe condividono una base comune, ma differiscono per architettura, connettività, funzionalità e modello operativo. NetApp Console utilizza agenti Console distribuiti nel tuo ambiente per gestire i sistemi di storage. NetApp Console con implementazione locale è una macchina virtuale senza agenti. NetApp Console con implementazione locale comunica direttamente con i cluster ONTAP e offre funzionalità di gestione della flotta aziendale non disponibili in NetApp Console.
...
https://docs.netapp.com/us-en/console-setup-admin/concept-modes.html["Scopri le modalità di distribuzione della NetApp Console"^].
...
link:https://docs.netapp.com/us-en/concept-netapp-console-local.html["Scopri la distribuzione locale della NetApp Console^."]
