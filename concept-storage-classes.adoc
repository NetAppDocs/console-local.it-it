...
Una vista di analisi spiega cosa è cambiato e perché. Potrebbero essere disponibili azioni di correzione guidate (per esempio, *Fix It*) per aiutarti a ripristinare la conformità. Alcune correzioni possono essere applicate direttamente, mentre altre potrebbero richiedere di allineare il carico di lavoro a una diversa classe di archiviazione per ripristinare il comportamento previsto.
...
link:concept-manage-storage.html["Scopri la gestione della flotta nella distribuzione locale di NetApp Console"].
...
* link:concept-manage-storage.html["Scopri la gestione della flotta nella distribuzione locale di NetApp Console"].
* link:task-storage-class-manage.html["Gestisci classi e criteri di archiviazione"].
...
* link:reference-console-assistant-operations.html["Vedi le operazioni supportate di Console assistant"]
* link:task-storage-class-drift-remediate.html["Scopri come rimediare alla deriva della storage class"]
