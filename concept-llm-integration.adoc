...
summary: Scopri come la distribuzione locale di NetApp Console si integra con OpenAI e i modelli compatibili con OpenAI, comprese le decisioni relative al provider e alla sicurezza. 
---
